extension JSON {
    ...
    @frozen public struct ArrayShapeError: Equatable, Error {
        public let count: Int
        public let expected: ArrayShapeCriteria?

        @inlinable public init(invalid: Int, expected: ArrayShapeCriteria? = nil) {
            self.count = invalid
